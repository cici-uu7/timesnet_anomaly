...
# TimesNet_AD_VAD 运行脚本 - SMAP 数据集
# SMAP: NASA 航天器遥测数据 (25 维)

echo "==========================================="
echo "TimesNet_AD_VAD - SMAP Dataset"
echo "==========================================="
echo ""
echo "Dataset: SMAP (NASA Spacecraft Telemetry)"
echo "  Variables: 25 (sensors + actuators)"
echo "  Expected: Strong physical coupling"
echo "  VAD适配度: ⭐⭐⭐⭐ (航天器物理约束强)"
echo ""
echo "Prior 融合策略:"
...
echo ""
echo "参数说明:"
echo "  --beta: VAD boost 权重 (默认0.5, SMAP用更大值)"
...
echo "  - β建议: 0.5~1.0 (SMAP相关性强,可以用更大β)"
echo "==========================================="
